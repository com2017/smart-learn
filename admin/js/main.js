...
function getAppRoot() {
	return getHostRoot()+'/'+ getDHISInstallFolder()+'/api/apps/smart-learn/admin/';
}
...
function isCourseAttendant(handler){
	var meurl = getApiRoot() + '/api/me';
	var courseurl = getApiRoot() + '/api/systemSettings/VJFS_courses';
	$.ajax({
		url: meurl,
		dataType: 'json'
