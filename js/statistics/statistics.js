...
function getstatQuestions(userquizUrl,username,courseCode,coursesIDList,userName){
     var quizurl = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_quizes';
     var courselst = [];
     var temp = 0;
    $.ajax({
        url: userquizUrl,
    ...
    var a = $.ajax({
        ...
        for(key in courses['courses']){
            ...
            for(keys in courses['courses'][key]['courseAttendants']){
                ...
                var nameUrl = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_' + name + '_quizes';
                var b = $.ajax({
                    url: nameUrl,
                    dataType: 'json'
...
function quizStats2(){
    ...
    $.ajax({
        ...
        for(key in courses['courses']){
            ...
            for(keys in courses['courses'][key]['courseAttendants']){
                var userUrl = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_' + courses['courses'][key]['courseAttendants'][keys].attendantUsername + '_questions';
                $.ajax({
                    url: userUrl,
                    dataType: 'json'
...
function displayStats() {
    ...
    var urlCourses = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_courses';
    var urlQuizes = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_quizes';
    var urlQuestions = getHostRoot() + '/'+DHISFolder+'/api/systemSettings/VJFS_questions';
    var q = [];
    var courseQuizes = [];
    var courseQuestions = [];
