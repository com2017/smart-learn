...
function saveQuestion(course_id, quiz_id, question_id) {
    ...
    getQuestions(function(questions) {
        ...
        setQuestions(JSON.stringify(questions), function() {
            window.location.href = getAppRoot() + 'pages/admin/quiz.html?course_id=' + course_id + '&quiz_id=' + quiz_id;
        });
    });
}
        ...
        if(questions != null) {
            ...
            setQuestions(JSON.stringify(questions), function() {
                getQuiz(quiz_id, function(quiz) {
                    window.location.href = getAppRoot() + 'pages/admin/quiz.html?course_id=' + quiz['courseID'] + '&quiz_id=' + quiz_id;
                })
            });
        }
    });
