    ...
    getCourses(function(courses) {
        ...
        if(courses != null) {
            ...
            for(key in courses['courses']) {
                ...
                course += '<a href="../admin/course.html?course_id=' + courses['courses'][key].courseID + '">' + courses['courses'][key].courseTitle + '</a>';
...
function saveCourse(course_id) {
    ...
    getCourses(function(courses) {
        ...
        setCourses(JSON.stringify(courses), function() {
            window.location.href = getAppRoot() +'/pages/admin/admin.html';
        });
    });
}
...
http://localhost:8080/demo/api/apps/smart-learn/pages/mentor/content/course.html?course_id=1480928151567